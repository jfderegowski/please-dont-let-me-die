...
namespace TinyGiantStudio.BetterInspector
{
    ...
    public class BetterTransformEditor : Editor
    {
        ...
        private void SetupPosition(VisualElement root)
        {
        ...
        private void UpdatePositionLabelContextMenu()
        {
            ...
            void UpdateContextMenuForPosition()
            {
                ...
                {
                    evt.menu.AppendAction("Position :", (x) => PasteRotation(), DropdownMenuAction.AlwaysDisabled);
        ...
        private void SetupRotation(VisualElement root)
        {
        ...
        private void UpdateRotationLabelContextMenu()
        {
            ...
            void UpdateContextMenuForRotation()
            {
                ...
                {
                    evt.menu.AppendAction("Rotation :", (x) => PasteRotation(), DropdownMenuAction.AlwaysDisabled);
                    evt.menu.AppendSeparator();
        ...
        private void SetGlobalScale(Transform t, Vector3 newLossyScale, bool ignoreAspectRatioLock = false)
        {
            ...
            if (!editorSettings.LockSizeAspectRatio || ignoreAspectRatioLock)
            {
                ...
                if (IsInfinity(newScale))
                    Debug.LogWarning("Unable to set world scale because the target world scale :" + newScale + " contains infinity. The most common cause of this issue is any object in it's parent hierarchy has scale with 0 value in any axis.", transform);
                else
        ...
        //TODO: Scale not being saved by animator
