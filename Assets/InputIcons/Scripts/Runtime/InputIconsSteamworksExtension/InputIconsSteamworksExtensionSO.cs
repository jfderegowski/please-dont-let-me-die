...
namespace InputIcons
{
    public class InputIconsSteamworksExtensionSO : ScriptableObject
    {
        ...
        public void HandleIconSetUpdated()
        {
            ...
            {
                //steam input not initialized, steam might not be running. Can not override current icon set.
            ...
            if (chosenInput != "")
                InputIconsLogger.Log("Steamworks override Icon Set: " + chosenInput);
            //else
              //  InputIconsLogger.Log("No Steamworks override");
